...
Prompt A/B tuning (5-episode sandbox): `python notes/expand_tune.py` — see `[docs/datapoint-workflow.md](docs/datapoint-workflow.md#prompt-tuning-5-episode-ab-sandbox)`.
