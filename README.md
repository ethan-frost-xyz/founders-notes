...
**Master index:** [`.cursor/plans/telegram_rag_bot_v0.plan.md`](.cursor/plans/telegram_rag_bot_v0.plan.md) · **SP plans:** [`sp1`](.cursor/plans/telegram_vault_sp1_tools.plan.md) → [`sp2`](.cursor/plans/telegram_vault_sp2_agent.plan.md) → [`sp3`](.cursor/plans/telegram_vault_sp3_telegram.plan.md) → [`sp4`](.cursor/plans/telegram_vault_sp4_ops.plan.md) (one per agent session) · **Overview:** [`docs/telegram-vault-agent.md`](docs/telegram-vault-agent.md) · Branch: `feature/telegram-vault-bot` → PR to `main`
